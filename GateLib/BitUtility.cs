...
public static class BitUtility
{
    ...
    public static BitArray ByteToBits(byte value) => new BitArray(new byte[] { value });
    ...
    public static bool IsBit(int val, int bit) => (val & (1 << bit)) == (1 << bit);

    public static int BitMask(bool val, byte bit) => val ? (1 << bit) : 0;
